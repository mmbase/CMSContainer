...
<mm:import externid="bottomurl" from="parameters">/editors/simple/SimpleContentDraftAction.do</mm:import>
...
<mm:locale language="${language}">
   ...
   <fmt:bundle basename="cmsc">
      <html:html xhtml="true">
         ...
         <frameset rows="30,*,30" framespacing="0" border="0">
            <frame src="header.jsp" name="toppane" frameborder="0" scrolling="no" noresize="noresize" style="border: 0px" />
            <frame src="<mm:url referid="bottompane"/>" name="bottompane" frameborder="0" scrolling="auto"/>
