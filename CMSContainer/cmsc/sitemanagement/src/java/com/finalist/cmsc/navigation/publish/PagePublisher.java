...
*/
package com.finalist.cmsc.navigation.publish;
...
import com.finalist.cmsc.repository.publish.ContentPublisher;
...
public class PagePublisher extends Publisher {
    ...
    protected void addContentBlock(Map<Node, Date> nodes, Node content) {
        ...
        List<Node> contentBlockNodes = ContentPublisher.findContentBlockNodes(content);
