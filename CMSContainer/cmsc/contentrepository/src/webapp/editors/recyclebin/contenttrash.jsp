                                     ...
                                     <table>
                                       <thead>
                                          <tr>
                                             ...
                                             <th style="width: 68px;"><a href="contenttrash.jsp?orderby=otype&direction=${direction}" class="headerlink"><fmt:message key="locate.typecolumn" /></a></th>
                                             <th><a href="contenttrash.jsp?orderby=title&direction=${direction}" class="headerlink"><fmt:message key="locate.titlecolumn" /></a></th>
                                             <th style="width: 120px;"><a href="contenttrash.jsp?orderby=lastmodifier&direction=${direction}" class="headerlink"><fmt:message key="locate.editorcolumn" /></a></th>
                                             <th style="width: 120px;"><a href="contenttrash.jsp?orderby=lastmodifieddate&direction=${direction}" class="headerlink"><fmt:message key="locate.lastmodifiedcolumn" /></a></th>
                                             <th style="width: 60px;"><a href="contenttrash.jsp?orderby=number&direction=${direction}" class="headerlink"><fmt:message key="locate.numbercolumn" /></a></th>
                                          </tr>
                                       </thead>
                                       <tbody class="hover">
                                 </mm:first>
