...
public class ChangeMyprofileInforAction extends MMBaseAction {
   ...
   private static final Logger log = Logging.getLoggerInstance(ChangeMyprofileInforAction.class.getName());
   ...
   public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
      ...
      if (!isCancelled(request)) {
         ...
         if (!isCancelled(request)) {
            ChangeMyprofileInforForm changeMyprofileInforForm = (ChangeMyprofileInforForm) form;
