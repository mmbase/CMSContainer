...
public abstract class AbstractSearchAction  extends PagerAction {
    ...
    */
   private static final Logger log = Logging.getLoggerInstance(ResourceSearchAction.class.getName());
   ...
   protected abstract void addStepsToQuery(Cloud cloud, SearchForm searchForm, NodeManager nodeManager, NodeQuery query);
